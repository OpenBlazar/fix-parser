...
public class FixMessageFactory {
    ...
    public List<FixMessage> prepareFixMessagesForLegalFixLong() {
        ...
        firstMsgFields.put(FixField.MsgType, new FixValue("8"));
        firstMsgFields.put(FixField.AvgPx, new FixValue("41.21"));
        firstMsgFields.put(FixField.CheckSum, new FixValue("024"));
        FixMessage firstMessage = new FixMessage(0L, FixVersion.FIX_42, FixMessageType.ExecutionReport, firstMsgFields);
        ...
        secondMsgFields.put(FixField.MsgType, new FixValue("8"));
        ...
        FixMessage secondMessage = new FixMessage(1L, FixVersion.FIX_42, FixMessageType.ExecutionReport, secondMsgFields);
        ...
        thirdMsgFields.put(FixField.MsgType,  new FixValue("8"));
        ...
        FixMessage thirdMessage = new FixMessage(2L, FixVersion.FIX_42, FixMessageType.ExecutionReport, thirdMsgFields);
