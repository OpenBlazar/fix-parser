...
public enum FixField {
    ...
    AdvId(2),
    AdvRefID(3),
    AdvSide(4, net.openblazar.bfp.data.fix.field.AdvSide::getDescriptionFromValue),
    AdvTransType(5, net.openblazar.bfp.data.fix.field.AdvTransType::getDescriptionFromValue),
    AvgPx(6),
    BeginSeqNo(7),
    BeginString(8),
    BodyLength(9),
    ...
    EndSeqNo(16),
    ExecID(17),
    ExecInst(18, net.openblazar.bfp.data.fix.field.ExecInst::getDescriptionFromValue),
    ExecRefID(19),
    ExecTransType(20, net.openblazar.bfp.data.fix.field.ExecTransType::getDescriptionFromValue),
    HandlInst(21),
    SecurityIDSource(22),
    IOIID(23),
    IOIOthSvc(24),
    ...
    NoLinesOfText(33),
    MsgSeqNum(34),
    MsgType(35, net.openblazar.bfp.data.fix.field.MsgType::getDescriptionFromValue),
    NewSeqNo(36),
    OrderID(37),
    OrderQty(38),
    OrdStatus(39, net.openblazar.bfp.data.fix.field.OrdStatus::getDescriptionFromValue),
    OrdType(40, net.openblazar.bfp.data.fix.field.OrdType::getDescriptionFromValue),
    OrigClOrdID(41),
    OrigTime(42),
    PossDupFlag(43),
    Price(44),
    ...
    SendingTime(52),
    Quantity(53),
    Side(54, net.openblazar.bfp.data.fix.field.Side::getDescriptionFromValue),
    Symbol(55),
    TargetCompID(56),
    TargetSubID(57),
    Text(58),
    TimeInForce(59, net.openblazar.bfp.data.fix.field.TimeInForce::getDescriptionFromValue),
    TransactTime(60),
    Urgency(61),
    ValidUntilTime(62),
    SettlType(63),
