...
public enum FixField {
    ...
    AdvId(2),
    AdvRefID(3),
    AdvSide(4, com.blazarquant.bfp.fix.data.field.AdvSide::getDescriptionFromValue),
    AdvTransType(5, com.blazarquant.bfp.fix.data.field.AdvTransType::getDescriptionFromValue),
    AvgPx(6),
    BeginSeqNo(7),
    BeginString(8),
    BodyLength(9),
    ...
    EndSeqNo(16),
    ExecID(17),
    ExecInst(18, com.blazarquant.bfp.fix.data.field.ExecInst::getDescriptionFromValue),
    ExecRefID(19),
    ExecTransType(20, com.blazarquant.bfp.fix.data.field.ExecTransType::getDescriptionFromValue),
    HandlInst(21),
    SecurityIDSource(22),
    IOIID(23),
    IOIOthSvc(24),
    ...
    NoLinesOfText(33),
    MsgSeqNum(34),
    MsgType(35, com.blazarquant.bfp.fix.data.field.MsgType::getDescriptionFromValue),
    NewSeqNo(36),
    OrderID(37),
    OrderQty(38),
    OrdStatus(39, com.blazarquant.bfp.fix.data.field.OrdStatus::getDescriptionFromValue),
    OrdType(40, com.blazarquant.bfp.fix.data.field.OrdType::getDescriptionFromValue),
    OrigClOrdID(41),
    OrigTime(42),
    PossDupFlag(43),
    Price(44),
    ...
    SendingTime(52),
    Quantity(53),
    Side(54, com.blazarquant.bfp.fix.data.field.Side::getDescriptionFromValue),
    Symbol(55),
    TargetCompID(56),
    TargetSubID(57),
    Text(58),
    TimeInForce(59, com.blazarquant.bfp.fix.data.field.TimeInForce::getDescriptionFromValue),
    TransactTime(60),
    Urgency(61),
    ValidUntilTime(62),
    SettlType(63),
    ...
    ExDestination(100),
    NotDefined(101),
    CxlRejReason(102, com.blazarquant.bfp.fix.data.field.CxlRejReason::getDescriptionFromValue),
    OrdRejReason(103, com.blazarquant.bfp.fix.data.field.OrdRejReason::getDescriptionFromValue),
    IOIQualifier(104),
    WaveNo(105),
    Issuer(106),
    SecurityDesc(107),
    ...
    Headline(148),
    URLLink(149),
    ExecType(150, com.blazarquant.bfp.fix.data.field.ExecType::getDescriptionFromValue),
    LeavesQty(151),
    CashOrderQty(152),
    AllocAvgPx(153),
    AllocNetMoney(154),
    ...
    FixField(int tag, Function<String, String> valueFunction) {
        this.tag = tag;
        this.valueFunction = valueFunction;
    }

    public static FixField getFieldFromTag(int tag) {
        FixField field = map.get(tag);
